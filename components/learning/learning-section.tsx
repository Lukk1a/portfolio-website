...
export function LearningSection() {
  return (
    ...
    >
      <SectionMarker
        number="03"
        label="ACTIVE RESEARCH RADAR & SPECIALIZATION"
        tag="// RADAR"
      />
      ...
      >
        ...
        <p className="text-sm sm:text-base text-content-secondary font-light max-w-2xl leading-relaxed">
          Focused exploration tracks pushing deeper into low latency
          concurrency, graphics shaders, and distributed consensus models.
        </p>
      </motion.div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between font-mono text-[11px]">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span
                      className={`px-2.5 py-0.5 rounded-full border font-mono text-[10px] ${
                        isInProgress
                ...
                <h3 className="text-base sm:text-lg font-medium text-content-primary tracking-tight leading-snug">
                  {item.topic}
                </h3>
