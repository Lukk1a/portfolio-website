          ...
          <Magnetic strength={0.15}>
            ...
            >
              ...
              <a
                ...
                className="flex items-center justify-between group-hover:text-white transition-colors pt-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/50 rounded-lg after:absolute after:inset-0 after:rounded-2xl"
              >
                <div>
